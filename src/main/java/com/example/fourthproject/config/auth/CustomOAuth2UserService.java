...
import com.example.fourthproject.config.auth.dto.OAuthAttributes;
import com.example.fourthproject.config.auth.dto.SessionUser;
import com.example.fourthproject.domain.user.User;
import com.example.fourthproject.domain.user.UserRepository;
